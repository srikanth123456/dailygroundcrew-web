          ...
          <div className="space-y-8 text-white">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-3 bg-black text-white px-5 py-3 rounded-xl
              ...
              >
                ...
                <div>
                  <p className="text-[10px] text-gray-300 leading-none tracking-wide">GET IT ON</p>
                  <p className="text-base font-bold leading-none mt-0.5">Google Play</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-[10px] text-gray-300 leading-none tracking-wide">DOWNLOAD ON THE</p>
                  <p className="text-base font-bold leading-none mt-0.5">App Store</p>
                </div>
              </a>
            </div>
